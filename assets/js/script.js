...
$(document).ready(function () {
    // var a;
    // function make_comment(i)
    // {
    //     var d = $("#parent-comment-text_"+i).val();
    //     d = $.trim(d);
    //     if (d.length < 2) {
    //         $("#parent-comment-text_"+i).addClass("comment-error");
    //         return false
    //     }
    //     if (a) {
    //         a.abort()
    //     }
    //     var b = $("#make-comment_"+i);
    //     var c = b.find("input, select, button, textarea");
    //     var f = parseInt($("#vr_comment_limit_"+i).val());
    ...
    //     a.done(function (h) {
    //         c.prop("disabled", false);
    //         $("#make-comment_"+i+" textarea").val("");
    //         document.getElementById("comment-result_"+i).innerHTML = h
    //     })
    // }

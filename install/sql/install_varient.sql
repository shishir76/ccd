...
--
-- Host: localhost
-- Generation Time: Jul 01, 2018 at 12:43 PM
...
(1, 1, 1, 'default', 1, 1, 1, 16, '', 'open_sans', 'roboto', 'verdana', 'smtp', '', '', '', '', '', '', '', 'Varient', '', '', '', 1, 1, 1, 1, 1, 1, 1, 1, 1, 8, 'Copyright © 2018 Varient - All Rights Reserved.', '', '', '', '', '', 'en', '2017-07-06 00:11:07');
...
(7, 1, 'Gallery', 'gallery', 'Varient Gallery Page', 'varient, gallery , page', 0, NULL, 2, 1, 1, 1, 0, 0, 'main', NULL, 0, 'page', '2017-11-22 17:33:50'),
...
INSERT INTO `settings` (`id`, `lang_id`, `site_title`, `home_title`, `site_description`, `keywords`, `application_name`, `facebook_url`, `twitter_url`, `google_url`, `instagram_url`, `pinterest_url`, `linkedin_url`, `vk_url`, `youtube_url`, `optional_url_button_name`, `about_footer`, `contact_text`, `contact_address`, `contact_email`, `contact_phone`, `map_api_key`, `latitude`, `longitude`, `copyright`, `cookies_warning`, `cookies_warning_text`, `created_at`) VALUES
(1, 1, 'Varient - News Magazine', 'Index', NULL, NULL, 'Varient', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Click Here To See More', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Copyright © 2018 Varient - All Rights Reserved.', 1, '<p>This site uses cookies. By continuing to browse the site you are agreeing to our use of cookies <a href=\"#\">Find out more here</a></p>\r\n', '2018-05-31 00:11:02');

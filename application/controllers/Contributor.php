...
class Contributor extends Home_Core_Controller
{
    ...
    public function update_profile()
    {
        ...
        $this->load->view('partials/_header', $data);
        $this->load->view('contributor/update_profile');
        $this->load->view('partials/_footer');
    }
    ...
    public function change_password()
    {
        ...
        $this->load->view('partials/_header', $data);
        $this->load->view('contributor/change_password');
        $this->load->view('partials/_footer');
    }
    ...
    public function reset_password()
    {
        ...
        $this->load->view('partials/_header', $data);
        $this->load->view('contributor/reset_password');
        $this->load->view('partials/_footer');
    }

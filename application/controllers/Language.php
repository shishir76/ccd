...
class Language extends Admin_Core_Controller
{
    ...
    public function add_language_post()
    {
        ...
        if ($this->form_validation->run() === false) {
            ...
            if (!$this->language_model->check_short_form()) {
                $this->session->set_flashdata('form_data', $this->language_model->input_values());
                $this->session->set_flashdata('error_form', trans("msg_lang_shortform_error"));
                redirect($this->agent->referrer());
                exit();
            }
            ...
            if ($this->language_model->add_language()) {
                ...
                $this->language_model->update_language_routes();
    ...
    public function update_language_post()
    {
        ...
        if ($this->form_validation->run() === false) {
            ...
            if (!$this->language_model->check_short_form()) {
                $this->session->set_flashdata('form_data', $this->language_model->input_values());
                $this->session->set_flashdata('error', trans("msg_lang_shortform_error"));
                redirect($this->agent->referrer());
                exit();
            }

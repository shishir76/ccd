            ...
            <div class="col-sm-12 page-login">
                <div class="row">
                    <div class="col-sm-6 col-xs-12 login-box-cnt center-box">
                        <div class="login-box">
                            <div class="box-head">
                                <h1 class="auth-title font-1"><?php echo trans("login"); ?></h1>
                            </div>
                            <div class="box-body">
                                ...
                                <!-- form start -->
                                <?php echo form_open("contributor/login_post"); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5 col-xs-5">
                                        <button type="submit" class="btn btn-primary btn-custom pull-right btn-login-pg">

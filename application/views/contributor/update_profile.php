        ...
        <div class="row">
            ...
            <div class="col-sm-12 page-breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><?php echo trans("update_profile"); ?></li>
                </ol>
            </div>
            ...
            <div class="col-sm-12 page-login">
                <div class="row">
                    <div class="col-sm-6 col-xs-12 login-box-cnt center-box">
                        <div class="login-box">
                            <div class="box-head">
                                <h1 class="auth-title font-1"><?php echo trans("update_profile"); ?></h1>
                            </div>

                            <div class="box-body">

                                <!-- form start -->
                                <?php echo form_open_multipart('contributor/update_profile_post'); ?>
                                ...
                                <div class="col-sm-12 col-update-profile">
                                    <div class="form-group has-feedback">
                                        <input type="email" class="form-control form-input"
                                               ...
                                               value="<?php echo html_escape($user->email); ?>" <?php echo ($rtl == true) ? 'dir="rtl"' : ''; ?> readonly>
                                    ...
                                    <div class="form-group has-feedback">
                                        <input type="text" class="form-control form-input"
                                               ...
                                               value="<?php echo html_escape($user->username); ?>" <?php echo ($rtl == true) ? 'dir="rtl"' : ''; ?> required>

        ...
        <div class="row">
            ...
            <div class="col-sm-12 page-breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><?php echo trans("change_password"); ?></li>
                </ol>
            </div>
            ...
            <div class="col-sm-12 page-login">
                <div class="row">
                    <div class="col-sm-6 col-xs-12 login-box-cnt center-box">
                        <div class="login-box">
                            <div class="box-head">
                                <h1 class="auth-title font-1"><?php echo trans("change_password"); ?></h1>
                            </div>
                            ...
                            <div class="box-body">
                                ...
                                <!-- form start -->
                                <?php echo form_open('contributor/change_password_post'); ?>

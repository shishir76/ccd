                    ...
                    <ul class="nav-sub-categories">
                        ...
                        <?php foreach (helper_get_subcategories($item->id) as $sub): ?>
                            <li data-category-filter="<?php echo html_escape($sub->name_slug); ?>-<?php echo html_escape($sub->id); ?>" class="li-sub-category">
                                <a href="<?php echo lang_base_url(); ?>category/<?php echo html_escape($sub->name_slug) ?>">
                                ...
                                <div class="col-sm-3 menu-post-item">
                                    <div class="post-item-image">
                                        <a href="<?php echo lang_base_url(); ?>post/<?php echo html_escape($post->title_slug); ?>">
                                            <?php $this->load->view("partials/_post_image", ["post" => $post, "icon_size" => "menu", "bg_size" => "md", "image_size" => "mid", "class" => "lazyload"]); ?>
                                        </a>
                                    </div>
                                    <h3 class="title">
                                        <a href="<?php echo lang_base_url(); ?>post/<?php echo html_escape($post->title_slug); ?>"><?php echo html_escape(character_limiter($post->title, 45, '...')); ?></a>
                                    </h3>
                                    <p class="post-meta">

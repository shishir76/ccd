...
<?php if (isset($_SESSION['vr_reaction_vote_count_' . $reactions->post_id]) && $_SESSION['vr_reaction_vote_count_' . $reactions->post_id] < 3): ?>
    <div class="col-reaction col-reaction-like" onclick="make_reaction('<?php echo $reactions->post_id; ?>', '<?php echo $reaction; ?>', '<?php echo $emoji_lang; ?>');">
        <div class="col-sm-12">
            <div class="row">
                <div class="icon-cnt">
                    <img src="<?php echo base_url(); ?>assets/img/reactions/<?php echo $reaction; ?>.gif" alt="<?php echo $reaction; ?>" class="img-reaction">
                </div>
            </div>
            <div class="row">

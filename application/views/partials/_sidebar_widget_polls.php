                            ...
                            <form data-form-id="<?php echo $poll->id; ?>" class="poll-form" method="post">
                                ...
                                for ($i = 1; $i <= 10; $i++):
                                    ...
                                    if (!empty($poll->$option)): ?>
                                        <p class="option">
                                            <input type="radio" name="option" id="option<?php echo $poll->id; ?>-<?php echo $i; ?>" value="<?php echo $option; ?>" class="flat-blue" required>
                                            <label for="option<?php echo $poll->id; ?>-<?php echo $i; ?>" class="label-poll-option"><?php echo html_escape($poll->$option); ?></label>
                                        </p>
                                    <?php
                                    endif;
                                endfor; ?>

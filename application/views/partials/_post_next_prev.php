    ...
    <div class="row">
        <div class="col-sm-6 col-xs-12 left">
            <?php if (!empty($previous_post)): ?>
                ...
                <h3 class="title">
                    <a href="<?php echo lang_base_url(); ?>post/<?php echo html_escape($previous_post->title_slug); ?>">
        ...
        <div class="col-sm-6 col-xs-12 right">
            <?php if (!empty($next_post)): ?>
                ...
                <h3 class="title">
                    <a href="<?php echo lang_base_url(); ?>post/<?php echo html_escape($next_post->title_slug); ?>">

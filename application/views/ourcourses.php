...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets1/styles/course.css">
		<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets1/styles/course_responsive.css">
	</head>
<body>
...
<div class="super_container">
	...
	<div class="intro">
		<div class="intro_background parallax-window" data-parallax="scroll" data-image-src="<?php echo base_url();?>assets1/images/intro.jpg" data-speed="0.8"></div>
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="intro_container d-flex flex-column align-items-start justify-content-end">
						<div class="intro_content">
							...
							<div class="intro_meta">
								<div class="intro_image"><img src="<?php echo base_url();?>assets1/images/intro_user.jpg" alt=""></div>
					...
					<div class="tab_panels">
								...
								<div class="row instructors_row">
									...
									<div class="col-lg-4 col-md-6">
										<div class="instructor d-flex flex-row align-items-center justify-content-start">
											<div class="instructor_image"><div><img src="<?php echo base_url();?>assets1/images/instructor_4.jpg" alt=""></div></div>
									...
									<div class="col-lg-4 col-md-6">
										<div class="instructor d-flex flex-row align-items-center justify-content-start">
											<div class="instructor_image"><div><img src="<?php echo base_url();?>assets1/images/instructor_5.jpg" alt=""></div></div>
											<div class="instructor_content">
												<div class="instructor_name"><a href="instructors.html">Sarah Parker</a></div>
												<div class="instructor_title">Teacher</div>
											</div>
									...
									<div class="col-lg-4 col-md-6">
										<div class="instructor d-flex flex-row align-items-center justify-content-start">
											<div class="instructor_image"><div><img src="<?php echo base_url();?>assets1/images/instructor_6.jpg" alt=""></div></div>
											<div class="instructor_content">
												<div class="instructor_name"><a href="instructors.html">Sarah Parker</a></div>
												<div class="instructor_title">Teacher</div>
											</div>
									...
									<div class="col-lg-4 col-md-6">
										<div class="instructor d-flex flex-row align-items-center justify-content-start">
											<div class="instructor_image"><div><img src="<?php echo base_url();?>assets1/images/instructor_7.jpg" alt=""></div></div>
											<div class="instructor_content">
												<div class="instructor_name"><a href="instructors.html">Sarah Parker</a></div>
												<div class="instructor_title">Teacher</div>
											</div>
									...
									<div class="col-lg-4 col-md-6">
										<div class="instructor d-flex flex-row align-items-center justify-content-start">
											<div class="instructor_image"><div><img src="<?php echo base_url();?>assets1/images/instructor_8.jpg" alt=""></div></div>
											<div class="instructor_content">
												<div class="instructor_name"><a href="instructors.html">Sarah Parker</a></div>
												<div class="instructor_title">Teacher</div>
											</div>
									...
									<div class="col-lg-4 col-md-6">
										<div class="instructor d-flex flex-row align-items-center justify-content-start">
											<div class="instructor_image"><div><img src="<?php echo base_url();?>assets1/images/instructor_9.jpg" alt=""></div></div>
											<div class="instructor_content">
												<div class="instructor_name"><a href="instructors.html">Sarah Parker</a></div>
												<div class="instructor_title">Teacher</div>
											</div>
								...
								<div class="review">
									<div class="review_title_container d-flex flex-row align-items-start justify-content-start">
										<div class="review_title d-flex flex-row align-items-center justify-content-center">
											<div class="review_author_image"><div><img src="<?php echo base_url();?>assets1/images/review_1.jpg" alt=""></div></div>
						...
						<div class="tab_panel members">
							...
							<div class="members_list d-flex flex-row flex-wrap align-items-start justify-content-start">
								...
								<!-- Member -->
								<div class="member">
									<div class="member_image"><img src="<?php echo base_url();?>assets1/images/member_1.jpg" alt=""></div>
									<div class="member_title"><a href="#">Sarah Parker</a></div>
								</div>

								<!-- Member -->
								<div class="member">
									<div class="member_image"><img src="<?php echo base_url();?>assets1/images/member_0.jpg" alt=""></div>
									<div class="member_title"><a href="#">Sarah Parker</a></div>
								</div>
								...
								<!-- Member -->
								<div class="member">
									<div class="member_image"><img src="<?php echo base_url();?>assets1/images/member_2.jpg" alt=""></div>
									<div class="member_title"><a href="#">Sarah Parker</a></div>
								</div>

								<!-- Member -->
								<div class="member">
									<div class="member_image"><img src="<?php echo base_url();?>assets1/images/member_3.jpg" alt=""></div>
									<div class="member_title"><a href="#">Sarah Parker</a></div>
								</div>

								<!-- Member -->
								<div class="member">
									<div class="member_image"><img src="<?php echo base_url();?>assets1/images/member_4.jpg" alt=""></div>
									<div class="member_title"><a href="#">Sarah Parker</a></div>
								</div>
								...
								<!-- Member -->
								<div class="member">
									<div class="member_image"><img src="<?php echo base_url();?>assets1/images/member_5.jpg" alt=""></div>
									<div class="member_title"><a href="#">Sarah Parker</a></div>
								</div>

								<!-- Member -->
								<div class="member">
									<div class="member_image"><img src="<?php echo base_url();?>assets1/images/member_6.jpg" alt=""></div>
									<div class="member_title"><a href="#">Sarah Parker</a></div>
								</div>
								...
								<!-- Member -->
								<div class="member">
									<div class="member_image"><img src="<?php echo base_url();?>assets1/images/member_7.jpg" alt=""></div>
									<div class="member_title"><a href="#">Sarah Parker</a></div>
								</div>

								<!-- Member -->
								<div class="member">
									<div class="member_image"><img src="<?php echo base_url();?>assets1/images/member_8.jpg" alt=""></div>
									<div class="member_title"><a href="#">Sarah Parker</a></div>
								</div>
								...
								<!-- Member -->
								<div class="member">
									<div class="member_image"><img src="<?php echo base_url();?>assets1/images/member_9.jpg" alt=""></div>
									<div class="member_title"><a href="#">Sarah Parker</a></div>
								</div>
					...
					<div class="sidebar">
						...
						<div class="sidebar_content">
							...
							<div class="sidebar_section cert">
								...
								<div class="cert_image"><img src="<?php echo base_url();?>assets1/images/cert.jpg" alt=""></div>
							</div>
...
<script src="<?php echo base_url();?>assets1/plugins/parallax-js-master/parallax.min.js"></script>
<script src="<?php echo base_url();?>assets1/plugins/progressbar/progressbar.min.js"></script>
<script src="<?php echo base_url();?>assets1/js/course.js"></script>
</body>
</html>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu options-list">
                                                ...
                                                <li>
                                                    <a class="p0">
                                                        <button type="submit" name="option" value="approve" class="btn-list-button">
                                                            <i class="fa fa-check i-delete"></i><?php echo trans('approve'); ?>
                                                        </button>
                                                    </a>
                                                </li>
                                            <?php endif; ?>
                                            ...
                                            <li>
                                                <a href="<?php echo base_url(); ?>admin_post/update_post/<?php echo html_escape($item->id); ?>?redirect_url=pending_posts">

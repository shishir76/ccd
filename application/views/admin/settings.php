    ...
    <div class="col-md-12">
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <li class=""><a href="#tab_8" data-toggle="tab" aria-expanded="false"><?php echo trans('footer_text'); ?></a></li>
            ...
            <div class="tab-content settings-tab-content">
                ...
                <div class="tab-pane" id="tab_3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="map_api_key"
                               placeholder="<?php echo trans('google_map_key'); ?>" value="<?php echo html_escape($settings->map_api_key); ?>" <?php echo ($rtl == true) ? 'dir="rtl"' : ''; ?>>
                    </div>

                    <div class="form-group">
                        <label class="control-label"><?php echo trans('latitude'); ?></label>
                        <input type="text" class="form-control" name="latitude"
                               placeholder="<?php echo trans('latitude'); ?>" value="<?php echo html_escape($settings->latitude); ?>" <?php echo ($rtl == true) ? 'dir="rtl"' : ''; ?>>
                    </div>

                    <div class="form-group">
                        <label class="control-label"><?php echo trans('longitude'); ?></label>
                        <input type="text" class="form-control" name="longitude"
                               placeholder="<?php echo trans('longitude'); ?>" value="<?php echo html_escape($settings->longitude); ?>" <?php echo ($rtl == true) ? 'dir="rtl"' : ''; ?>>
                    </div>
                ...
                <div class="tab-pane" id="tab_4">
                    ...
                    <div class="form-group">
                        <label class="control-label">Android App <?php echo trans('url'); ?></label>
                        <input type="text" class="form-control" name="android_app_url"
                               placeholder="Android App <?php echo trans('url'); ?>" value="<?php echo html_escape($settings->android_app_url); ?>" <?php echo ($rtl == true) ? 'dir="rtl"' : ''; ?>>
                    </div>

                    <div class="form-group">
                        <label class="control-label">Apple App <?php echo trans('url'); ?></label>
                        <input type="text" class="form-control" name="apple_app_url"
                               placeholder="Apple App <?php echo trans('url'); ?>" value="<?php echo html_escape($settings->apple_app_url); ?>" <?php echo ($rtl == true) ? 'dir="rtl"' : ''; ?>>
                    </div>
                ...
                <div class="tab-pane" id="tab_5">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control text-area" name="facebook_comment" placeholder="<?php echo trans('facebook_comments_code'); ?>"
                                  style="min-height: 140px;" <?php echo ($rtl == true) ? 'dir="rtl"' : ''; ?>><?php echo html_escape($general_settings->facebook_comment); ?></textarea>
                    </div>
                ...
                <div class="tab-pane" id="tab_6">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control text-area" name="head_code" placeholder="<?php echo trans('head_code'); ?>"
                                  style="min-height: 140px;" <?php echo ($rtl == true) ? 'dir="rtl"' : ''; ?>><?php echo html_escape($general_settings->head_code); ?></textarea>
                    </div>
                ...
                <div class="tab-pane" id="tab_8">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-3 col-xs-12 col-lang">
                                <label><?php echo trans('show_footer_text'); ?></label>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                                <input type="radio" name="footer_text" value="1" id="footer_text_1"
                                       class="square-purple" <?php echo ($settings->footer_text == 1) ? 'checked' : ''; ?>>
                                <label for="footer_text_1" class="option-label"><?php echo trans('yes'); ?></label>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                                <input type="radio" name="footer_text" value="0" id="footer_text_2"
                                       class="square-purple" <?php echo ($settings->footer_text != 1) ? 'checked' : ''; ?>>
                                <label for="footer_text_2" class="option-label"><?php echo trans('no'); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label"><?php echo trans('footer_text_editor'); ?></label>
                        <textarea class="form-control ckeditor" name="footer_text_editor"><?php echo html_escape($settings->footer_text_editor); ?></textarea>
                    </div>

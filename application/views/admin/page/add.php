    ...
    <div class="col-sm-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="right">
                    <a href="<?php echo base_url(); ?>page/pages" class="btn btn-sm btn-success btn-add-new">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="page_order" placeholder="<?php echo trans('order'); ?>" value="1" min="1" style="width: 300px;max-width: 100%;" <?php echo ($rtl == true) ? 'dir="rtl"' : ''; ?>>
                </div>

    ...
    <div class="col-sm-12 col-xs-12">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <?php if ($page->slug != "index" && $page->slug != "gallery" && $page->slug != "register" && $page->slug != "login" && $page->slug != "reset-password" && $page->slug != "update-profile" && $page->slug != "change-password" && $page->slug != "contact" && $page->slug != "posts" && $page->slug != "videos" && $page->slug != "rss-feeds" && $page->slug != "reading-list" && $page->slug != "user-agreement" && $page->slug != "user-agreement"): ?>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-3 col-xs-12 col-lang">

<div class="box">
    <div class="box-header with-border">
        ...
        <div class="right">   <a href="<?php echo base_url(); ?>admin_post/add_post" class="btn btn-sm btn-success btn-add-new pull-right">
                    <i class="fa fa-plus"></i>
                    <?php echo trans('add_new_post'); ?>
                </a></div>
    </div><!-- /.box-header -->
 ...
 <div class="form-group">
   ...
   <?php if (is_admin()): ?>
        ...
        <?php else: ?>
            <input type="hidden" name="need_auth" value="<?php echo $post->need_auth; ?>">
        <?php endif; ?>

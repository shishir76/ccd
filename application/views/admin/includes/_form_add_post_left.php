 ...
 <?php if (is_admin() || is_author()): ?>
    ...
    <?php endif; ?>
     ...
     <div class="form-group">
            <div class="row">
                <div class="col-sm-12">
                    <label class="control-label left"><?php echo trans('content'); ?></label> 
                    <span class="right" id="ckediter_options_button" style="float:right;cursor: pointer;">Options</span>
                    <textarea id="ckEditor" class="form-control"
                              name="content" height="800px" placeholder="Content" required><?php echo old('content'); ?></textarea>
                </div>
            </div>
        </div>
 <?php if (is_admin() || is_author()): ?>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control callAjax" name="keywords"
  ...
  <div class="form-group">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <input id="tags_1" type="text" name="tags" class="form-control tags targetAjax"/>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-9 col-sm-12">
                        <input type="checkbox" name="is_featured" value="1" class="square-purple" <?php echo (old('is_featured') == 1) ? 'checked' : ''; ?> checked>
                    </div>
                </div>
            </div>
      <?php else: ?>
   ...
   <?php if (is_admin() || is_author()): ?>
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-9 col-sm-12">
                        <input type="checkbox" name="is_breaking" value="1" class="square-purple" <?php echo (old('is_breaking') == 1) ? 'checked' : ''; ?> checked>
                    </div>
                </div>
            </div>
       ...
       <?php if (is_admin() || is_author()): ?>
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-9 col-sm-12">
                        <input type="checkbox" name="is_slider" value="1" class="square-purple" <?php echo (old('is_slider') == 1) ? 'checked' : ''; ?> checked>
                    </div>
                </div>
            </div>
     <?php else: ?>
         ...
         <?php if (is_admin() || is_author()): ?>
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-9 col-sm-12">
                        <input type="checkbox" name="is_recommended" value="1" class="square-purple" <?php echo (old('is_recommended') == 1) ? 'checked' : ''; ?> checked>
                    </div>
                </div>
            </div>
     <?php else: ?>

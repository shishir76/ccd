<div class="row table-filter-container">
    <div class="col-sm-12">
        ...
        <?php elseif (user()->role == "author"): ?>
            <div class="item-table-filter">
                <label><?php echo trans("contributor"); ?></label>
                <select name="contributor" class="form-control">
                    <option value=""><?php echo trans("all"); ?></option>
                    <?php foreach ($contributors as $contributor): ?>
                        <option value="<?php echo $contributor->id; ?>"
                            <?php echo ($this->input->get('contributor', true) == $contributor->id) ? 'selected' : ''; ?>>
                            <?php echo html_escape($contributor->username); ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            </div>
        ...
        <?php if (user()->role == "admin"): ?>
            <div class="item-table-filter" style="display:none;">
                <label><?php echo trans("month"); ?></label>
                <select name="month" class="form-control">
                    ...
                    <?php
                        ...
                        for ($i = 1; $i <= 12; $i++)
                        {
                            $month = date('F', mktime(0, 0, 0, $i, 1, 2017));
                            ?>
                            <option <?php if($get_month==$i){echo "selected";}?> value="<?php echo $i; ?>"><?php echo $month; ?></option>
                            <?php
                        }
                    ?>
                </select>
     ...
     <div class="col-md-3">
         <div class="item-table-filter">
            ...
            <input name="from_post" class="form-control"  type="text">
...
<div class="item-table-filter">
            ...
            <input name="to_post" class="form-control" type="text">
             <span class="input-group-addon">
                            <span class="glyphicon glyphicon-calendar"></span>
                        </span>
        </div>

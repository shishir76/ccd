<div class="box">
    ...
    <div class="box-body">
        ...
        <div id="date_published_content" class="form-group">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12 col-lang">
        ...
        <div class="form-group">
            <button type="submit" name="status" id="publish_post_btn" value="1" class="btn btn-primary pull-right"><?php echo trans('publish_post'); ?></button>

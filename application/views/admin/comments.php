                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped dataTable" id="cs_datatable" role="grid" aria-describedby="example1_info">
                        ...
                        <tr role="row">
                            ...
                            <th><?php echo trans('seen_status'); ?></th>
                                                ...
                                                <li>
                                                    <a class="p0">
                                                        <button type="submit" name="option" value="approve" class="btn-list-button"
                                                                onclick="return confirm('<?php echo trans("confirm_approve"); ?>');">
                                                            <i class="fa fa-stop-circle i-delete"></i><?php echo trans('approve'); ?>
                                                        </button>
                                                    </a>
                                                </li>
                                            <?php else: ?>
                                                <li>
                                                    <a class="p0">
                                                        <button type="submit" name="option" value="disapprove" class="btn-list-button"
                                                                onclick="return confirm('<?php echo trans("confirm_disapprove"); ?>');">
                                                            <i class="fa fa-stop-circle i-delete"></i><?php echo trans('disapprove'); ?>
                                                        </button>
                                                    </a>
                                                </li>
                                            <?php endif; ?>

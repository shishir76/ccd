                    ...
                    <div class="tab-content">
                        ...
                        <?php for ($i = 1; $i <= $tab_count; $i++): ?>
                            ...
                            <div id="tab<?php echo $i; ?>" class="tab-pane fade <?php echo ($page == $i) ? 'in active' : ''; ?>">
                                ...
                                <?php echo form_open('language/update_phrases_post'); ?>
                                ...
                                <div class="col-sm-12 m-t-30">
                                    <div class="row">
                                        <div class="pull-right">
                                            <a href="<?php echo $this->agent->referrer(); ?>" class="btn btn-danger m-r-5"><?php echo trans('back'); ?></a>
                                ...
                                <ul class="pagination">
                                    <?php for ($i = 1; $i <= $tab_count; $i++): ?>
                                        <li class="<?php echo ($page == $i) ? 'active' : ''; ?>">
                                            <a href="<?php echo base_url(); ?>language/update_phrases/<?php echo $language->id; ?>?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                                        </li>
                                    <?php endfor; ?>
                                </ul>
                            </div>

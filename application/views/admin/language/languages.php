...
<div class="row">
    <div class="col-lg-5 col-md-12">
        <div class="box box-primary">
            ...
            <!-- form start -->
            <?php echo form_open('language/set_language_post'); ?>
        ...
        <div class="box box-primary">
            ...
            <!-- form start -->
            <?php echo form_open('language/add_language_post'); ?>
                            ...
                            <table class="table table-bordered table-striped dataTable" id="cs_datatable" role="grid"
                                ...
                                <?php foreach ($languages as $item): ?>
                                    <tr>
                                        ...
                                        <td><a href="<?php echo base_url(); ?>language/update_phrases/<?php echo $item->id; ?>?page=1" class="btn btn-sm btn-success">
                                                <?php echo trans('edit_phrases'); ?>
                                            </a></td>
                                        <td>
                                            <!--Form delete category-->
                                            <?php echo form_open('language/delete_language_post'); ?>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a href="<?php echo base_url(); ?>language/update_language/<?php echo html_escape($item->id); ?>"><i
                                                                    class="fa fa-edit i-edit"></i><?php echo trans('edit'); ?></a></li>
                                                    <li>
                                                        <a class="p0">
                                                            <button type="submit" class="btn-list-button"
                                                                    onclick="return confirm('<?php echo trans("confirm_language"); ?>');">

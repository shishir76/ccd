        ...
        <div class="box box-primary">
            ...
            <div class="box-footer">
                <div class="form-group">
                 ...
                 <button type="submit" class="btn btn-warning btn-draft " value="0" name="status"><?php echo trans('draft_rss_feed'); ?></button> &nbsp;&nbsp;&nbsp;
                <button type="submit" class="btn btn-primary pull-right" value="1" name="status"><?php echo trans('import_rss_feed'); ?></button>
            </div> </div>
            <!-- /.box-footer -->

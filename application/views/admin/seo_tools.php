...
<div class="row">
    ...
    <div class="col-sm-12">
        <div class="form-group">
            ...
            <select name="lang_id" class="form-control max-400" onchange="window.location.href = '<?php echo base_url(); ?>'+'admin/seo_tools?lang='+this.value;">
    ...
    <div class="col-lg-6 col-md-12">
        ...
        <div class="callout" style="margin-top: 30px;background-color: #fff; border-color:#00c0ef;max-width: 600px;">
            <h4>Cron Job</h4>
            <p><strong>http://domain.com/cron/update_sitemap</strong></p>

                                            ...
                                            <li>
                                                <a class="p0">
                                                    <button type="button" class="btn-list-button" data-toggle="modal"
                                                            data-target="#myModal"
                                                            onclick="show_change_user_role('<?php echo html_escape($user->id); ?>');">
                                                        <i class="fa fa-user i-edit"></i><?php echo trans('change_user_role'); ?>
                                                    </button>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="<?php echo base_url(); ?>admin/reset_password/<?php echo html_escape($user->id); ?>">
                                                    <i class="fa fa-lock i-edit"></i><?php echo trans('reset_password'); ?></a>
                                            </li>
                                            <?php if ($user->status == "1"): ?>
                                                <li>
                                                    <a class="p0">
...
<div id="myModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="change_user_role_data">
...
<script>
    function show_change_user_role(id) 
    {
        $.ajax({
            url: '<?php echo base_url();?>admin/change_user_role/?id='+id,
            type: "GET",
            success:function(response) 
            {
                $('#change_user_role_data').html(response);
                $('#myModal').modal('show');
            }
        });
    }

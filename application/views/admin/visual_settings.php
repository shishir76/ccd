            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12 p0" style="margin-bottom: 30px;">
                        <div class="row">
                            <div class="col-sm-3">
                                <img src="<?php echo get_logo($visual_settings); ?>" alt="" style="max-width: 300px;margin-bottom: 10px;">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12 p0" style="margin-bottom: 30px;">
                        <div class="row">
                            <div class="col-sm-3">
                                <img src="<?php echo get_logo_footer($visual_settings); ?>" alt="" style="max-width: 300px;margin-bottom: 10px;">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                <a class='btn btn-success btn-sm btn-file-upload'>
                                    <?php echo trans('change_logo'); ?>
                                    <input type="file" name="logo_footer" size="40" accept=".png, .jpg, .jpeg, .gif" onchange="$('#upload-file-info2').html($(this).val());">
                                </a>
                            </div>
                        </div>

...
class Auth_model extends CI_Model
{
    ...
    public function reset_password_input_values()
    {
        $data = array(
    ...
    public function admin_login()
    {
        ...
        if (!empty($user)) {
            ...
            if ($user->role != "admin" && $user->role != "author" && $user->role != "contributor") {
                return false;
            }
    ...
    public function login_with_facebook()
    {
        ...
        if (empty($user)) {
            ...
            $data = array(
                ...
                'slug' => str_slug($first_name . " " . $last_name . "-" . uniqid()),
    ...
    public function logout()
    {
        ...
        helper_deletecookie("varient_user_id");
    ...
    //change password
    public function change_password($old_password_empty,$id)
    {
        $id = $this->input->post('id', true);
    ...
    public function update_reset_password($id)
    {
        ...
        if (!empty($user)) {
            ...
            $data = $this->reset_password_input_values();
    ...
    {
        helper_setcookie("varient_user_id", $user_id);
    }

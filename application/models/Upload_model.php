...
class Upload_model extends CI_Model
{
    ...
    public function post_big_image_upload($file)
    {
        ...
        if ($this->my_upload->uploaded == true) {
            ...
            $this->my_upload->file_new_name_body =  $base_name. uniqid();
    ...
    //epaper big image upload
    public function epaper_big_image_upload($file)
    {
        $this->my_upload->upload($file);
        if ($this->my_upload->uploaded == true) {
            $this->my_upload->file_new_name_body = 'image_1920x_' . uniqid();
            ...
            $this->my_upload->image_x = 1920;
            $this->my_upload->image_ratio_y = true;
            $this->my_upload->process('./uploads/epaper/');
            $image_path = "uploads/epaper/" . $this->my_upload->file_dst_name;
            return $image_path;
        } else {
            return null;
        }
    ...
    //epaper small image upload
    public function epaper_small_image_upload($file)
    {
        $this->my_upload->upload($file);
        if ($this->my_upload->uploaded == true) {
            $this->my_upload->file_new_name_body = 'image_500x_' . uniqid();
